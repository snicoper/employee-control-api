...
public interface IEmployeeHolidaysRepository
{
    ...
    Task<bool> ExistsByYearAndEmployeeId(int year, Guid employeeId, CancellationToken cancellationToken);
    ...
    Task<EmployeeHoliday> CreateAsync(int year, Guid employeeId, CancellationToken cancellationToken);
}
