        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CompanyId = table.Column<Guid>(type: "uuid", nullable: false),
                    CompanyCalendarId = table.Column<Guid>(type: "uuid", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CompanyCalendarHolidays", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CompanyCalendarHolidays_CompanyCalendars_CompanyCalendarId",
                        column: x => x.CompanyCalendarId,
                        principalTable: "CompanyCalendars",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    UserId = table.Column<Guid>(type: "uuid", nullable: false),
                    CompanyTaskId = table.Column<Guid>(type: "uuid", nullable: false),
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    Created = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    CreatedBy = table.Column<Guid>(type: "uuid", nullable: true),
                    LastModified = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Date = table.Column<DateOnly>(type: "date", nullable: false),
                    UserId = table.Column<Guid>(type: "uuid", nullable: false),
                    EmployeeHolidayClaimId = table.Column<Guid>(type: "uuid", nullable: false),
                    Created = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    CreatedBy = table.Column<Guid>(type: "uuid", nullable: true),
                    LastModified = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    LastModifiedBy = table.Column<Guid>(type: "uuid", nullable: true)
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_CompanyCalendarId",
                table: "AspNetUsers",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CompanyCalendarHolidays_CompanyCalendarId",
